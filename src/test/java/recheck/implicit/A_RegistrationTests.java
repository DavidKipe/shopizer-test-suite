...
//	private RecheckDriver recheckDriver;
//
	HomePO homePO;
...
//		homePO = new HomePO(recheckDriver);
	...
	public void testRegisterMemberWithEmptyFirstName() {
		...
		RecheckOptions recheckOptions = RecheckOptions.builder().build();
		RecheckDriver recheckDriver = new RecheckDriver((RemoteWebDriver) driver);

		recheckDriver.startTest("testRegisterMemberWithEmptyFirstName");
...
//		RecheckOptions recheckOptions = RecheckOptions.builder().build();
		...
		recheckDriver.startTest("testRegisterMemberWithEmptyLastName");
